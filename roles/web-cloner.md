...
- **DESIGN.md:** Human-readable style reference — colors, typography, spacing, components (lives in `.maxxy-me/roles/clonner/DESIGN.md`)
- **Tailwind Config:** `@theme` block with all extracted tokens (lives in `.maxxy-me/roles/clonner/tailwind.config.md`)
- **CSS Variables:** `:root` custom properties for framework-agnostic usage (lives in `.maxxy-me/roles/clonner/css-variables.md`)
- **Design Tokens:** W3C-format JSON tokens for cross-platform consumption (lives in `.maxxy-me/roles/clonner/design-tokens.md`)
...
├── Check .maxxy-me/roles/clonner/ for user-provided files
...
### 5. Auto-Fill Detection for `.maxxy-me/roles/clonner/` Files
...
function getClonnerFileStatus(): Record<string, boolean> {
  const base = ".maxxy-me/roles/clonner";
  return {
...
| File in `.maxxy-me/roles/clonner/` | What It Contains | Source Priority |
|--------------------------|-----------------|----------------|
...
6. [ ] .maxxy-me/roles/clonner/ files populated (user or auto-fill)
...
### File Management
- **Ignore the `.maxxy-me/roles/clonner/` template files** — always check if user provided custom values before auto-filling
...
- [ ] All 4 files in `.maxxy-me/roles/clonner/` are populated (user-provided or auto-filled, no `{placeholder}` remaining)
...
Design Files:
  .maxxy-me/roles/clonner/DESIGN.md:        <user-provided / auto-filled>
  .maxxy-me/roles/clonner/tailwind.config.md: <user-provided / auto-filled>
  .maxxy-me/roles/clonner/css-variables.md:  <user-provided / auto-filled>
  .maxxy-me/roles/clonner/design-tokens.md:  <user-provided / auto-filled>
